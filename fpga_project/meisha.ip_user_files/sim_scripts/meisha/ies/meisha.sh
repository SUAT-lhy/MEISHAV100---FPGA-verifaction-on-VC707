...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.meisha \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../meisha.srcs/sources_1/bd/meisha/ipshared/100a" \
       +incdir+"$ref_dir/../../../../meisha.srcs/sources_1/bd/meisha/ipshared/7e3a/hdl" \
       +incdir+"../../../../meisha.srcs/sources_1/bd/meisha/ipshared/100a" \
       +incdir+"../../../../meisha.srcs/sources_1/bd/meisha/ipshared/7e3a/hdl"
}

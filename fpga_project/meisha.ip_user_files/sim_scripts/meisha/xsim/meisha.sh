...
xv_path="/eda/vivado2016/Vivado/2016.4"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L util_ds_buf_v2_01_a -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_10 -L util_vector_logic_v2_0 -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_1_3 -L axi_clock_converter_v2_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot meisha xil_defaultlib.meisha xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim meisha -key {Behavioral:sim_1:Functional:meisha} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/eda/vivado2016/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb meisha.wdb xsim.dir)

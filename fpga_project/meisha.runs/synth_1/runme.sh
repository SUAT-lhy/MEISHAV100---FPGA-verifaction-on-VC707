...
HD_PWD='/home/test/vivado_prj/MEISHAV100---FPGA-verifaction-on-VC707/fpga_project/meisha.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log meisha_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source meisha_wrapper.tcl

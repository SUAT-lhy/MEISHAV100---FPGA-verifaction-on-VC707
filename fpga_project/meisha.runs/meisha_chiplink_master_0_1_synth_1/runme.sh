...
HD_PWD='/home/test/vivado_prj/meisha_zhenli/meisha.runs/meisha_chiplink_master_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log meisha_chiplink_master_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source meisha_chiplink_master_0_1.tcl

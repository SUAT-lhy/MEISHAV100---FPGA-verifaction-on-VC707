module TLMonitor_58( 
  ...
  assign _T_38 = ~ _T_37; 
  assign _GEN_18 = {{23'd0}, _T_38}; 
  assign _T_39 = io_in_a_bits_address & _GEN_18; 
  assign _T_40 = _T_39 == 26'h0; 
  ...
  assign _T_125 = io_in_a_bits_address ^ 26'h2000000; 
  assign _T_126 = {1'b0,$signed(_T_125)}; 
  assign _T_127 = $signed(_T_126) & $signed(-27'sh10000); 
  assign _T_128 = $signed(_T_127); 
  assign _T_129 = $signed(_T_128) == $signed(27'sh0); 

module DivSqrtRecFNToRaw_small_1( 
  ...
  wire  rawA_S_isInf; 
  wire  rawA_S_sign; 
  wire [12:0] rawA_S_sExp; 
  wire  _T_42; 
  wire [51:0] _T_43; 
  wire [1:0] _T_44; 
  wire [53:0] rawA_S_sig; 
  wire [11:0] _T_46; 
  wire [2:0] _T_47; 
  wire  rawB_S_isZero; 
  wire [1:0] _T_49; 
  ...
  wire  rawB_S_isInf; 
  wire  rawB_S_sign; 
  wire [12:0] rawB_S_sExp; 
  wire  _T_59; 
  wire [51:0] _T_60; 
  wire [1:0] _T_61; 
  wire [53:0] rawB_S_sig; 
  wire  _T_63; 
  wire  _T_64; 
  ...
  assign _T_98 = rawB_S_sExp[11]; 
  assign _T_99 = rawB_S_sExp[10:0]; 
  assign _T_100 = ~ _T_99; 
  assign _T_101 = {_T_98,_T_100}; 
  assign _T_102 = $signed(_T_101); 
  assign _GEN_13 = {{1{_T_102[11]}},_T_102}; 
  assign sExpQuot_S_div = $signed(rawA_S_sExp) + $signed(_GEN_13); 
  assign _T_103 = $signed(14'she00) <= $signed(sExpQuot_S_div); 
  assign _T_104 = sExpQuot_S_div[12:9]; 
  assign _T_105 = _T_103 ? 4'h6 : _T_104; 
  assign _T_106 = sExpQuot_S_div[8:0]; 
  ...
  assign idle = cycleNum == 6'h0; 
  assign inReady = cycleNum <= 6'h1; 
  assign entering = inReady & io_inValid; 
  assign entering_normalCase = entering & normalCase_S; 
  assign _T_111 = cycleNum == 6'h3; 
  assign _T_112 = sigX_Z[54]; 
  ...
  assign _T_157 = _T_155 ? _T_156 : 56'h0; 
  assign rem = _T_154 | _T_157; 
  assign _T_158 = 64'h1 << cycleNum; 
  assign bitMask = _T_158[63:2]; 
  assign _T_160 = inReady & _T_90; 
  assign _GEN_20 = {{1'd0}, rawB_S_sig}; 
  assign _T_161 = _GEN_20 << 1; 
  assign _T_162 = _T_160 ? _T_161 : 55'h0; 
  assign _T_163 = inReady & evenSqrt_S; 
  assign _T_164 = _T_163 ? 54'h20000000000000 : 54'h0; 
  assign _GEN_21 = {{1'd0}, _T_164}; 
  assign _T_165 = _T_162 | _GEN_21; 
  assign _T_167 = _T_145 ? 55'h50000000000000 : 55'h0; 
  ...
  assign _T_174 = _T_171 ? _T_173 : 54'h0; 
  ...
  assign _GEN_25 = {{6'd0}, _T_178}; 
  assign _T_179 = _GEN_25 | bitMask; 
  assign _T_180 = _T_177 ? _T_179 : 62'h0; 
  assign _GEN_26 = {{7'd0}, _T_175}; 
  assign trialTerm = _GEN_26 | _T_180; 
  assign _T_181 = {1'b0,$signed(rem)}; 
  assign _T_182 = {1'b0,$signed(trialTerm)}; 
  assign _GEN_27 = {{6{_T_181[56]}},_T_181}; 
  assign _T_184 = $signed(_GEN_27) - $signed(_T_182); 
  assign trialRem = $signed(_T_184); 
  assign newBit = $signed(63'sh0) <= $signed(trialRem); 
  assign _T_185 = cycleNum > 6'h2; 
  assign _T_186 = entering_normalCase | _T_185; 
  assign _T_187 = $unsigned(trialRem); 
  assign _T_188 = newBit ? _T_187 : {{7'd0}, rem}; 
  assign _GEN_10 = _T_186 ? _T_188 : {{8'd0}, rem_Z}; 
  assign _T_190 = _T_155 & newBit; 
  assign _T_191 = entering_normalCase | _T_190; 
  assign _T_192 = $signed(trialRem) != $signed(63'sh0); 
  assign _GEN_28 = {{54'd0}, newBit}; 
  assign _T_195 = _GEN_28 << 54; 
  assign _T_196 = _T_160 ? _T_195 : 55'h0; 
  assign _T_197 = inReady & io_sqrtOp; 
  assign _T_198 = _T_197 ? 54'h20000000000000 : 54'h0; 
  assign _GEN_29 = {{1'd0}, _T_198}; 
  assign _T_199 = _T_196 | _GEN_29; 
  assign _GEN_30 = {{52'd0}, newBit}; 
  assign _T_201 = _GEN_30 << 52; 
  assign _T_202 = _T_145 ? _T_201 : 53'h0; 
  assign _GEN_31 = {{2'd0}, _T_202}; 
  assign _T_203 = _T_199 | _GEN_31; 
  assign _GEN_32 = {{7'd0}, sigX_Z}; 
  assign _T_205 = _GEN_32 | bitMask; 
  assign _T_206 = _T_155 ? _T_205 : 62'h0; 
  assign _GEN_33 = {{7'd0}, _T_203}; 
  assign _T_207 = _GEN_33 | _T_206; 
  assign _GEN_12 = _T_191 ? _T_207 : {{7'd0}, sigX_Z}; 
  assign rawOutValid = cycleNum == 6'h1; 
  assign _T_212 = isNaN_Z == 1'h0; 
  assign _GEN_35 = {{55'd0}, notZeroRem_Z}; 
  assign io_inReady = cycleNum <= 6'h1; 

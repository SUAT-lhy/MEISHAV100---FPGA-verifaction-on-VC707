...
(
  ...
  assign sdo_valid_oen = (running != 1'b1);
  assign sdo_oen[0]  = sdo_valid_oen || (en_quad_in == 1'b0);  // standard mode, used for input
  assign sdo_oen[1]  = sdo_valid_oen;
  assign sdo_oen[2]  = sdo_valid_oen || (en_quad_in == 1'b0);  // standard mode, unused
  assign sdo_oen[3]  = sdo_valid_oen || (en_quad_in == 1'b0);  // standard mode, unused

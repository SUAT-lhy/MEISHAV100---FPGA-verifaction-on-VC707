module AsyncQueueSink_10( 
  ...
  wire [80:0] deq_bits_reg_io_d; 
  wire [80:0] deq_bits_reg_io_q; 
  ...
  SynchronizerShiftReg_w81_d1 deq_bits_reg ( 
  ...
  assign io_deq_bits_opcode = _T_110[80:78]; 
  assign io_deq_bits_param = _T_110[77:76]; 
  assign io_deq_bits_size = _T_110[75:73]; 
  assign io_deq_bits_source = _T_110[72:69]; 
  assign io_deq_bits_sink = _T_110[68:66]; 
  assign io_deq_bits_denied = _T_110[65]; 

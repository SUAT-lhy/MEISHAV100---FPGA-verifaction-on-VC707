module TLMonitor_57( 
  ...
  assign _T_125 = io_in_a_bits_address ^ 28'hc000000; 
  assign _T_126 = {1'b0,$signed(_T_125)}; 
  assign _T_127 = $signed(_T_126) & $signed(-29'sh4000000); 
  assign _T_128 = $signed(_T_127); 
  assign _T_129 = $signed(_T_128) == $signed(29'sh0); 

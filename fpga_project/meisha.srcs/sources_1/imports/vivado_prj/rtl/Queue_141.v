module Queue_141( 
  ...
  reg [31:0] _T_35_data [0:1]; 
  reg [31:0] _RAND_0;
  wire [31:0] _T_35_data__T_58_data; 
  wire  _T_35_data__T_58_addr; 
  wire [31:0] _T_35_data__T_50_data; 
  wire  _T_35_data__T_50_addr; 
  wire  _T_35_data__T_50_mask; 
  wire  _T_35_data__T_50_en; 
  reg [3:0] _T_35_strb [0:1]; 
  reg [31:0] _RAND_1;
  wire [3:0] _T_35_strb__T_58_data; 
  wire  _T_35_strb__T_58_addr; 
  wire [3:0] _T_35_strb__T_50_data; 
...
`ifdef RANDOMIZE
  ...
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_data[initvar] = _RAND_0[31:0];
  `endif // RANDOMIZE_MEM_INIT
  _RAND_1 = {1{`RANDOM}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_strb[initvar] = _RAND_1[3:0];
  `endif // RANDOMIZE_MEM_INIT
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  value = _RAND_2[0:0];

module TLBuffer_23( 
  ...
  wire [37:0] Queue_io_enq_bits_address; 
  ...
  wire [37:0] Queue_io_deq_bits_address; 
  ...
  wire [37:0] Queue_2_io_enq_bits_address; 
  wire [7:0] Queue_2_io_enq_bits_mask; 
  wire  Queue_2_io_enq_bits_corrupt; 
  ...
  wire [37:0] Queue_2_io_deq_bits_address; 
  wire [7:0] Queue_2_io_deq_bits_mask; 
  ...
  wire [37:0] Queue_3_io_enq_bits_address; 
  wire [63:0] Queue_3_io_enq_bits_data; 
  wire  Queue_3_io_enq_bits_corrupt; 
  ...
  wire [37:0] Queue_3_io_deq_bits_address; 
  ...
  assign Queue_2_io_enq_bits_opcode = auto_out_b_bits_opcode; 
  assign Queue_2_io_enq_bits_param = auto_out_b_bits_param; 
  assign Queue_2_io_enq_bits_size = auto_out_b_bits_size; 
  assign Queue_2_io_enq_bits_source = auto_out_b_bits_source; 
  assign Queue_2_io_enq_bits_address = auto_out_b_bits_address; 
  assign Queue_2_io_enq_bits_mask = auto_out_b_bits_mask; 
  assign Queue_2_io_enq_bits_corrupt = auto_out_b_bits_corrupt; 
  ...
  assign Queue_3_io_enq_bits_corrupt = auto_in_c_bits_corrupt; 
  ...
  assign Queue_4_io_deq_ready = auto_out_e_ready; 
endmodule

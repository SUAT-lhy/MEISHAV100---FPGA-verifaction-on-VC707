module Queue_W_Channel #(
  ...
  input  [DATA_WIDTH/8-1:0]  io_enq_bits_strb, 
  input         io_enq_bits_last, 
  input         io_deq_ready, 
  output        io_deq_valid, 
  output [DATA_WIDTH-1:0] io_deq_bits_data, 
  output [DATA_WIDTH/8-1:0]  io_deq_bits_strb, 
  ...
  reg [DATA_WIDTH/8-1:0] _T_35_strb [0:1]; 
  reg [31:0] _RAND_1;
  wire [DATA_WIDTH/8-1:0] _T_35_strb__T_58_data; 
  wire  _T_35_strb__T_58_addr; 
  wire [DATA_WIDTH/8-1:0] _T_35_strb__T_50_data; 
  wire  _T_35_strb__T_50_addr; 
  wire  _T_35_strb__T_50_mask; 
  wire  _T_35_strb__T_50_en; 
  reg  _T_35_last [0:1]; 
  reg [31:0] _RAND_2;
  ...
  assign _T_35_strb__T_58_data = _T_35_strb[_T_35_strb__T_58_addr]; 
  ...
  assign io_deq_bits_strb = _T_35_strb__T_58_data; 
...
`ifdef RANDOMIZE
  ...
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_data[initvar] = _RAND_0[DATA_WIDTH-1:0];
...
`endif // RANDOMIZE
  always @(posedge clock) begin
    ...
    if(_T_35_strb__T_50_en & _T_35_strb__T_50_mask) begin
      _T_35_strb[_T_35_strb__T_50_addr] <= _T_35_strb__T_50_data; 
    end

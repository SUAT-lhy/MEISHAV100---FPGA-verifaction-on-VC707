module Queue_45( 
  ...
  reg [5:0] _T_35_id [0:0]; 
  reg [31:0] _RAND_0;
  wire [5:0] _T_35_id__T_52_data; 
  wire  _T_35_id__T_52_addr; 
  wire [5:0] _T_35_id__T_48_data; 
  wire  _T_35_id__T_48_addr; 
  wire  _T_35_id__T_48_mask; 
  wire  _T_35_id__T_48_en; 
  reg [31:0] _T_35_addr [0:0]; 
  reg [31:0] _RAND_1;
  wire [31:0] _T_35_addr__T_52_data; 
  wire  _T_35_addr__T_52_addr; 
  wire [31:0] _T_35_addr__T_48_data; 
  ...
  reg  _T_35_lock [0:0]; 
  reg [31:0] _RAND_5;
  wire  _T_35_lock__T_52_data; 
  wire  _T_35_lock__T_52_addr; 
  wire  _T_35_lock__T_48_data; 
  wire  _T_35_lock__T_48_addr; 
  wire  _T_35_lock__T_48_mask; 
  wire  _T_35_lock__T_48_en; 
  reg [3:0] _T_35_cache [0:0]; 
  reg [31:0] _RAND_6;
  wire [3:0] _T_35_cache__T_52_data; 
  wire  _T_35_cache__T_52_addr; 
  wire [3:0] _T_35_cache__T_48_data; 
  wire  _T_35_cache__T_48_addr; 
  wire  _T_35_cache__T_48_mask; 
  wire  _T_35_cache__T_48_en; 
  reg [2:0] _T_35_prot [0:0]; 
  reg [31:0] _RAND_7;
  wire [2:0] _T_35_prot__T_52_data; 
  wire  _T_35_prot__T_52_addr; 
  wire [2:0] _T_35_prot__T_48_data; 
  wire  _T_35_prot__T_48_addr; 
  wire  _T_35_prot__T_48_mask; 
  wire  _T_35_prot__T_48_en; 
  reg [3:0] _T_35_qos [0:0]; 
  reg [31:0] _RAND_8;
  wire [3:0] _T_35_qos__T_52_data; 
  wire  _T_35_qos__T_52_addr; 
  wire [3:0] _T_35_qos__T_48_data; 
  wire  _T_35_qos__T_48_addr; 
  wire  _T_35_qos__T_48_mask; 
  wire  _T_35_qos__T_48_en; 
  reg [10:0] _T_35_user [0:0]; 
  reg [31:0] _RAND_9;
  wire [10:0] _T_35_user__T_52_data; 
  wire  _T_35_user__T_52_addr; 
  wire [10:0] _T_35_user__T_48_data; 
  ...
  assign _T_35_lock__T_52_data = _T_35_lock[_T_35_lock__T_52_addr]; 
  ...
  assign _T_35_cache__T_52_data = _T_35_cache[_T_35_cache__T_52_addr]; 
  ...
  assign _T_35_prot__T_52_data = _T_35_prot[_T_35_prot__T_52_addr]; 
  ...
  assign _T_35_qos__T_52_data = _T_35_qos[_T_35_qos__T_52_addr]; 
  ...
  assign io_deq_bits_lock = _T_39 ? 1'h0 : _T_35_lock__T_52_data; 
  assign io_deq_bits_cache = _T_39 ? 4'h0 : _T_35_cache__T_52_data; 
  assign io_deq_bits_prot = _T_39 ? 3'h1 : _T_35_prot__T_52_data; 
  assign io_deq_bits_qos = _T_39 ? 4'h0 : _T_35_qos__T_52_data; 
...
`endif // RANDOMIZE
  always @(posedge clock) begin
    ...
    if(_T_35_lock__T_48_en & _T_35_lock__T_48_mask) begin
      _T_35_lock[_T_35_lock__T_48_addr] <= _T_35_lock__T_48_data; 
    end
    if(_T_35_cache__T_48_en & _T_35_cache__T_48_mask) begin
      _T_35_cache[_T_35_cache__T_48_addr] <= _T_35_cache__T_48_data; 
    end
    if(_T_35_prot__T_48_en & _T_35_prot__T_48_mask) begin
      _T_35_prot[_T_35_prot__T_48_addr] <= _T_35_prot__T_48_data; 
    end
    if(_T_35_qos__T_48_en & _T_35_qos__T_48_mask) begin
      _T_35_qos[_T_35_qos__T_48_addr] <= _T_35_qos__T_48_data; 
    end

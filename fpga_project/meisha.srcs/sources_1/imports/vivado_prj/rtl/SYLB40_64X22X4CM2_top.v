...
(
    ...
    output  wire    [87:0]   Data_out   // Data outputs
);
    // 实例化 SYLB40_64X22X4CM2 模块
    SYLB40_64X22X4CM2 u_SYLB40_64X22X4CM2 (
        ...
        .DI84(Data_in[84]), .DI85(Data_in[85]), .DI86(Data_in[86]), .DI87(Data_in[87]),
        ...
        .DO84(Data_out[84]), .DO85(Data_out[85]), .DO86(Data_out[86]), .DO87(Data_out[87])
    );

module Queue_A_Channel #(
  ...
  input  [ADDR_WIDTH-1:0] io_enq_bits_addr, 
  ...
  output [ADDR_WIDTH-1:0] io_deq_bits_addr, 
  ...
  reg [ADDR_WIDTH-1:0] _T_35_addr [0:1]; 
  reg [31:0] _RAND_1;
  wire [ADDR_WIDTH-1:0] _T_35_addr__T_58_data; 
  wire  _T_35_addr__T_58_addr; 
  wire [ADDR_WIDTH-1:0] _T_35_addr__T_50_data; 
...
`ifdef RANDOMIZE
  ...
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_addr[initvar] = _RAND_1[ADDR_WIDTH-1:0];
  `endif // RANDOMIZE_MEM_INIT
  _RAND_2 = {1{`RANDOM}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)

module AsyncResetRegVec_para # (parameter BIT_WIDTH = 13) ( 
  input         clock, 
  input         reset, 
  input  [BIT_WIDTH-1:0] io_d_i, 
  output [BIT_WIDTH-1:0] io_q_o, 
  input         io_en 
);
  wire  reg_0_rst; 
  wire  reg_0_clk; 
  ...
  assign io_d[13-1:0] = {{(13-BIT_WIDTH){1'b0}}, io_d_i[BIT_WIDTH-1:0]};
  
  assign io_q_o[BIT_WIDTH-1:0] = {io_q[BIT_WIDTH-1:0]};

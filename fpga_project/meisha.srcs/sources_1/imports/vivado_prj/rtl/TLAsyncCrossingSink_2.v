module TLAsyncCrossingSink_2( 
  ...
  input  [3:0]  auto_in_a_mem_1_mask, 
  input  [31:0] auto_in_a_mem_1_data, 
  ...
  input  [3:0]  auto_in_a_mem_2_mask, 
  input  [31:0] auto_in_a_mem_2_data, 
  ...
  input  [3:0]  auto_in_a_mem_3_mask, 
  input  [31:0] auto_in_a_mem_3_data, 
  ...
  input  [3:0]  auto_in_a_mem_4_mask, 
  input  [31:0] auto_in_a_mem_4_data, 
  ...
  input  [3:0]  auto_in_a_mem_5_mask, 
  input  [31:0] auto_in_a_mem_5_data, 
  ...
  input  [3:0]  auto_in_a_mem_6_mask, 
  input  [31:0] auto_in_a_mem_6_data, 
  ...
  input  [3:0]  auto_in_a_mem_7_mask, 
  input  [31:0] auto_in_a_mem_7_data, 
  ...
  output        auto_in_d_mem_1_sink, 
  output        auto_in_d_mem_1_denied, 
  output [31:0] auto_in_d_mem_1_data, 
  ...
  output        auto_in_d_mem_2_sink, 
  output        auto_in_d_mem_2_denied, 
  output [31:0] auto_in_d_mem_2_data, 
  ...
  output        auto_in_d_mem_3_sink, 
  output        auto_in_d_mem_3_denied, 
  output [31:0] auto_in_d_mem_3_data, 
  ...
  output        auto_in_d_mem_4_sink, 
  output        auto_in_d_mem_4_denied, 
  output [31:0] auto_in_d_mem_4_data, 
  ...
  output        auto_in_d_mem_5_sink, 
  output        auto_in_d_mem_5_denied, 
  output [31:0] auto_in_d_mem_5_data, 
  ...
  output        auto_in_d_mem_6_sink, 
  output        auto_in_d_mem_6_denied, 
  output [31:0] auto_in_d_mem_6_data, 
  ...
  output        auto_in_d_mem_7_sink, 
  output        auto_in_d_mem_7_denied, 
  output [31:0] auto_in_d_mem_7_data, 
  ...
  wire [4:0] AsyncQueueSink_io_deq_bits_source; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_0_source; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_1_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_1_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_1_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_1_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_2_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_2_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_2_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_2_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_3_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_3_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_3_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_3_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_4_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_4_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_4_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_4_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_5_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_5_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_5_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_5_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_6_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_6_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_6_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_6_data; 
  ...
  wire [4:0] AsyncQueueSink_io_async_mem_7_source; 
  wire [37:0] AsyncQueueSink_io_async_mem_7_address; 
  wire [3:0] AsyncQueueSink_io_async_mem_7_mask; 
  wire [31:0] AsyncQueueSink_io_async_mem_7_data; 
  ...
  wire [4:0] AsyncQueueSource_io_enq_bits_source; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_0_source; 
  wire  AsyncQueueSource_io_async_mem_0_sink; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_1_source; 
  wire  AsyncQueueSource_io_async_mem_1_sink; 
  wire  AsyncQueueSource_io_async_mem_1_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_1_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_2_source; 
  wire  AsyncQueueSource_io_async_mem_2_sink; 
  wire  AsyncQueueSource_io_async_mem_2_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_2_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_3_source; 
  wire  AsyncQueueSource_io_async_mem_3_sink; 
  wire  AsyncQueueSource_io_async_mem_3_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_3_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_4_source; 
  wire  AsyncQueueSource_io_async_mem_4_sink; 
  wire  AsyncQueueSource_io_async_mem_4_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_4_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_5_source; 
  wire  AsyncQueueSource_io_async_mem_5_sink; 
  wire  AsyncQueueSource_io_async_mem_5_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_5_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_6_source; 
  wire  AsyncQueueSource_io_async_mem_6_sink; 
  wire  AsyncQueueSource_io_async_mem_6_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_6_data; 
  ...
  wire [4:0] AsyncQueueSource_io_async_mem_7_source; 
  wire  AsyncQueueSource_io_async_mem_7_sink; 
  wire  AsyncQueueSource_io_async_mem_7_denied; 
  wire [31:0] AsyncQueueSource_io_async_mem_7_data; 
  ...
  AsyncQueueSink_9 AsyncQueueSink ( 
  ...
  AsyncQueueSource_9 AsyncQueueSource ( 

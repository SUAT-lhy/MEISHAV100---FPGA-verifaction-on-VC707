...
If the signal is 1 (DIP switch down), the system boots from IRAM. Other DIP switches (second to fifth) are set to "1010", See Figure 3 for the dip switch setup diagram.


![alt text](photo/board-switch.jpg)
